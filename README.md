This R Notebook project process data from the Tall Tower database to compute the average value of different sensors at the same height for each parameter (humidity, pressure, wind direction and speed). 
