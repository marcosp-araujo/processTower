...
This [R Markdown](http://rmarkdown.rstudio.com) processes raw data from the Tall Tower database. The processing consists of reading the .csv file input file with raw data and computing the average value between measurements from sensors (humidity,
pressure, wind direction and speed) installed at different booms of the mast at the same height. It requires data in .csv format derived from the following repository [Tower2csv](https://github.com/marcosp-araujo/Tower2csv):
